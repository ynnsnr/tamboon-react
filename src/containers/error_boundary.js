...
import { ErrorBoundaryContent } from '../style';

class ErrorBoundary extends React.Component {
  render() {
    if (this.props.errors.length > 0) {
      return (
        <ErrorBoundaryContent className="mt-5 pt-5">
          <svg className="Cog"
          ...
          <h1 className="MainTitle mt-4">An error has occurred</h1>
          <p className="Main Description mt-3">{this.props.errors[0]}</p>
